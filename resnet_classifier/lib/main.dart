...
import 'package:resnet_classifier/run_model_by_camera_demo.dart';
import 'package:resnet_classifier/run_model_by_image_demo.dart';
import 'package:resnet_classifier/run_model_by_image_picker_camera_demo.dart';
...
class _ChooseDemoState extends State<ChooseDemo> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('RESNET CLASSIFIER'),
        ),
