...
/// The purpose of this widget is to encapsulate all of the necessary logic
...
///
/// NOTE: main reason for making this a separate component was because the
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        showModal(
          ...
          // Mark exercise as nullable (Exercise?)
          if (exercise != null) {
